...
from sec.MySampler import ProportionalDownsampler
from sec.LightNet import LightNet
...
class Res18Backbone(nn.Module):
    ...
    def __init__(self, pretrained=True, input_resolution=224, **kwargs):
        super().__init__()
        net = torchvision.models.resnet18(weights=torch.models.VGG19_Weights.DEFAULT)
        net.fc = nn.Identity()
        self.net = net
        self.input_resolution = input_resolution
...
class CoNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.autoencoder = LightNet(dim=8, expand=2)
        ...
        # self.fusion = TransformerBlock_Optimized(dim=16, num_heads=4, ffn_expansion_factor=2.66)
